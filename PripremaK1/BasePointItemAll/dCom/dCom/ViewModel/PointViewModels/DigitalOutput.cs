...
namespace dCom.ViewModel
{
	public class DigitalOutput : BasePointItem
	{
		...
		public DigitalOutput(PointType type, ushort address, ushort defaultValue, FunctionExecutor commandExecutor, string name, IStateUpdater stateUpdater) : base(type, address, commandExecutor, name, stateUpdater, defaultValue)
		{
